...
namespace lab02
{
    internal class Win4
    {
        ...
        {
            window4 = new Window();
            window4.Title = "Калькулятор";
            window4.ResizeMode = ResizeMode.NoResize;
            myGrid = new Grid();
            window4.Height = 650;
            window4.Width = 650;
            window4.Background = new SolidColorBrush(Colors.LightYellow);
            ...
            //
            Back4 = new Button();
            Back4.Content = "На Головну";
            Back4.Click += Back4_Click;
            Back4.Background = new SolidColorBrush(Colors.Red);
