...
namespace lab02
{
    internal class Win5
    {
        ...
        {
            window5= new Window();
            window5.Title = "Дані про розробника";
            window5.ResizeMode = ResizeMode.NoResize;
            myGrid = new Grid();
            window5.Height = 650;
            window5.Width = 650;
            window5.Background = new SolidColorBrush(Colors.LightYellow);
            ...
            label2.Content = "Сорока Микита Іванович";
            label2.FontSize = 28;
            ...
            //
            Back5 = new Button();
            Back5.Background = new SolidColorBrush(Colors.MistyRose);
            Back5.Content = "Повернутися на головну";
            Back5.Click += Back5_Click;
            Grid.SetRow(Back5, 4);
            Grid.SetColumn(Back5, 2);
